...
class ListAllStudentPayment extends StatefulWidget {
  @override
  _ListAllStudentPaymentState createState() => _ListAllStudentPaymentState();
}

class _ListAllStudentPaymentState extends State<ListAllStudentPayment> {
                ...
                child: GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>
                        PaymentHistory(studentId: _getChild[index].StudAcadID,)
                    ));
                  },
                  child: Card(
